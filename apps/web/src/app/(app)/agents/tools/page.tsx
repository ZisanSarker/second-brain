    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      <div className="mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Tool Inspector</h1>
      ...
      <div className="space-y-4">
        {tools?.map((tool: any) => (
          <div key={tool.name} className="rounded-lg border border-border bg-popover/30 p-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <pre className="rounded bg-popover p-2 text-xs text-muted-foreground overflow-auto max-h-32">
